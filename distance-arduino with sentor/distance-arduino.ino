...
calcPIDAngle(setMidpoint, avgMidpoint);
  ...
  */
  ...
  avgMidpointAngle = (avgMidpointAngle - 35)*2-100; //scaling cuz servo stupido
...
void calcPIDAngle(float setmidpoint, float midpoint) {
 ...
 // Serial.println(" integral");
  ...
  avgMidpointAngle = (output + 646)*255/1292; //scales from max input to 0-255
